...
$GLOBALS['TL_DCA']['tl_module']['palettes']['login'] = str_replace('{template_legend:hide}','{wbgym_legend},wb_settingsPage,wb_vplanPage,wb_profilePage,wb_emailLink;{template_legend:hide}',$GLOBALS['TL_DCA']['tl_module']['palettes']['login']);
